...
class FPLPlayer:
    ...
    def is_winner(self, current_week):
        return self.get_current_week_outcome(current_week) == PlayerOutcome.WIN

    def is_loser(self, current_week):
        return self.get_current_week_outcome(current_week) == PlayerOutcome.LOSS

    def is_draw(self, current_week):
        return self.get_current_week_outcome(current_week) == PlayerOutcome.DRAW
